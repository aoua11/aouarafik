            ...
            <nav className="border-b bg-[#f9f9f9] text-black">
                <div className="  mx-28 sm:px-6 lg:px-8">
                    <div className="relative flex items-center justify-between h-16">
                        <div className="absolute inset-y-0 right-64 flex items-center sm:hidden">
                            <button
                                type="button"
                        ...
                        <Link href="/">
                            ...
                            <Link href="/products"><div className=" px-3 py-2 rounded-md text-sm font-semibold">product</div></Link>
                            <Link href="/support"><div className=" px-3 py-2 rounded-md text-sm font-semibold">support</div></Link>
                            <div className="relative">
                            <Link href="/contact"><div className=" px-3 py-2 rounded-md text-sm font-semibold">
                                        contact
                                    </div>
                                    </Link>
                                </div>
                                <Link href="/about"><div  className=" px-3 py-2 rounded-md text-sm font-semibold">about</div></Link>
                            </div>
...
//         <>
//             <header className="px-32 border-b bg-[#f9f9f9]">
//                 <nav className="hidden lg:flex justify-between py-3">
...
//                         <Link href="/products"><li className="text-sm font-semibold px-3 hover:text-[#EC4B9A]">Product</li></Link>
//                         <Link href="/support"><li className="text-sm font-semibold px-3 hover:text-[#EC4B9A]">support</li></Link>
//                         <Link href="/contact"><li className="text-sm font-semibold px-3 hover:text-[#EC4B9A]">Contact</li></Link>
//                         <Link href="/about"><li className="text-sm font-semibold px-3 hover:text-[#EC4B9A]">About us</li></Link>
